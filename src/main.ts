  ...
  http.get('/movies/:id', ({ params }) => {
    const options = {
      ...
      'e0fcd0ca-609c-4dd0-82e0-020482856380': {
        ...
        poster:
          'https://www.wizardingworld.com/images/products/films/rectangle-7.png',
